...
// Rota de pagamento (só funciona se SDK estiver presente)
app.post('/create-preference', async (req, res) => {
  if (!MercadoPagoConfig || !Preference) {
    return res.status(501).json({ error: 'Mercado Pago não configurado no servidor' });
  }
  try {
...
// Servir o index.html para qualquer rota
app.get('*', (req, res) => {
